 ...
 *
 * <iframe src="https://www.google.com/calendar/embed?src=..."></iframe>
 *
 ...
 */
$calColorBgDark      = '#ffa200';	// dark background color
$calColorTextOnDark  = '#ffffff';	// text appearing on top of dark bg color
$calColorBgLight     = '#ffeccb';	// light background color
$calColorTextOnLight = '#000000';	// text appearing on top of light bg color
$calColorBgToday     = '#fef0ff';	// background color for "today" box
